...
test_that("random.Erlang work correctly", {
...
test_that("pdf.Erlang work correctly", {
...
test_that("log_pdf.Erlang work correctly", {
...
test_that("cdf.Erlang work correctly", {
...
test_that("quantile.Erlang work correctly", {
