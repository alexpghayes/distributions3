...
test_that("pdf.GEV works correctly", {
  ...
  expect_equal(pdf(g2, xvec), c(0, exp(-1), 0, NA))
...
test_that("quantile.GEV works correctly", {
  ...
  expect_equal(quantile(g1, pvec), c(-10, q1, Inf, NA))
  ...
  expect_equal(quantile(g3, pvec), c(-Inf, q3, 10, NA))
