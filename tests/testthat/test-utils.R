...
test_that("apply_dpqr() applied to 'random' works", {
  ...
  expect_equal({set.seed(123); random(N[1], 1)}, {set.seed(123); drop(random(N[1], 1))})
  expect_equal({set.seed(123); random(N_named[1], 1)}, {set.seed(123); drop(random(N_named[1], 1))})
  ...
  expect_equal({set.seed(123); random(N, 1)}, {set.seed(123); drop(random(N, 1))})
  expect_equal({set.seed(123); random(N_named, 1)}, {set.seed(123); drop(random(N_named, 1))})
  ...
  expect_equal({set.seed(123); random(N[1], 2)}, {set.seed(123); drop(random(N[1], 2))})
  expect_equal({set.seed(123); random(N_named[1], 2)}, {set.seed(123); drop(random(N_named[1], 2))})
  ...
  expect_equal({set.seed(123); random(N[1:2], 2)}, {set.seed(123); drop(random(N[1:2], 3)[, -3L, drop = FALSE])})
  expect_equal({set.seed(123); random(N_named[1:2], 2)}, {set.seed(123); drop(random(N_named[1:2], 3)[, -3L, drop = FALSE])})

  # length(d) = n > 1, drop = FALSE
  expect_equal({set.seed(123); random(N[1:2], 2, drop = FALSE)}, {set.seed(123); drop(random(N[1:2], 3, drop = FALSE)[, -3L, drop = FALSE])})
  expect_equal({set.seed(123); random(N_named[1:2], 2, drop = FALSE)}, {set.seed(123); drop(random(N_named[1:2], 3, drop = FALSE)[, -3L, drop = FALSE])})

  # length(d) > 1, n > 1, drop = TRUE
  expect_true(is.numeric(random(N, 2)))
  expect_equal(dim(random(N, 2)), c(3L, 2L))
  expect_equal({set.seed(123); random(N, 2)}, {set.seed(123); drop(random(N, 2))})
  expect_equal({set.seed(123); random(N_named, 2)}, {set.seed(123); drop(random(N_named, 2))})
  ...
  expect_equal({set.seed(123); random(N, cbind(2), drop = FALSE)}, {set.seed(123); random(N, 2, drop = FALSE)})
  expect_equal({set.seed(123); random(N, rbind(2), drop = FALSE)}, {set.seed(123); random(N, 2, drop = FALSE)})
