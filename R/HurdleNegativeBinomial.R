...
#' X <- HurdleNegativeBinomial(mu = 2.5, pi = 0.75)
#' X
#'
#' ## standard functions
#' pdf(X, 0:8)
...
#' @export
#'
pdf.HurdleNegativeBinomial <- function(d, x, drop = TRUE, ...) {
...
#' @export
#'
log_pdf.HurdleNegativeBinomial <- function(d, x, drop = TRUE, ...) {
...
#' @export
#'
cdf.HurdleNegativeBinomial <- function(d, x, drop = TRUE, ...) {
